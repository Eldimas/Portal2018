...
namespace PortalApp.API.Migrations
{
    ...
    [Migration("20181213151817_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortalApp.API.Models.ContentConfigsSerialized", b =>
                {
                    ...
                    b.Property<Guid?>("DocumentConfigVId");
            ...
            modelBuilder.Entity("PortalApp.API.Models.DocumentConfigV", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("PortalApp.API.Models.WfConfigsSerialized", b =>
                {
                    ...
                    b.ToTable("WfConfigsSerializeds");
                });
            ...
            modelBuilder.Entity("PortalApp.API.Models.ContentConfigsSerialized", b =>
                {
                    b.HasOne("PortalApp.API.Models.DocumentConfigV")
                        .WithMany("ContentConfigsSerialized")
                        .HasForeignKey("DocumentConfigVId");
                });
